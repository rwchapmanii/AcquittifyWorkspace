...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate full SCOTUS ontology coverage and edge constraints.")
...
def main() -> None:
    ...
    json_path = report_dir / "scotus_full_validation_report.json"
    json_path.write_text(json.dumps(report, indent=2, ensure_ascii=False), encoding="utf-8")

    md_lines = [
        "# SCOTUS Full Validation Report",
        "",
    ...
    md_path = report_dir / "scotus_full_validation_report.md"
    md_path.write_text("\n".join(md_lines) + "\n", encoding="utf-8")
