locals {
  ...
  frontend_fqdn = var.frontend_subdomain == "" ? var.domain_name : "${var.frontend_subdomain}.${var.domain_name}"
  api_fqdn      = var.api_subdomain == "" ? var.domain_name : "${var.api_subdomain}.${var.domain_name}"
